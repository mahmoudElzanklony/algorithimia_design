...
export default {
  ...
  data(){
    return {
      ...
      selected_cat_id:0,
      meta:{
        description:'algorithimia company for software products in web and mobile',
        keywords:'algorithimia.com,algorithimia,software ksa , web , mobile'
      },
    }
  },
  methods:{
